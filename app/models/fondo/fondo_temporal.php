	 ...
	 */
        function completa_tipoInstit_abreviados($instit)
        {
            ...
            $b = array("ESCUELA DE EDUCACIÓN TÉCNICA (E.E.T.)",
                       ...
                       "INSTITUTO PROVINCIAL DE EDUCACION AGROTECNICA (I.P.E.A.)",
                       "INSTITUTO PROVINCIAL DE EDUCACIÓN AGROTÉCNICA Y MEDIA (I.P.E.A.Y M.)",
                       "INSTITUTO PROVINCIAL DE EDUCACIÓN AGROTÉCNICA Y TÉCNICA (I.P.E.A.Y T.)",
                       "INSTITUTO PROVINCIAL DE EDUCACION TECNICA AGROTECNICA Y MEDIA (I.P.E.T.A.y M.)",
                       "INSTITUTO PROVINCIAL DE EDUCACIÓN TÉCNICA (I.P.E.T.)",
                       "INSTITUTO PROVINCIAL DE EDUCACIÓN TÉCNICA Y MEDIA (I.P.E.T.Y M.)",
                       "INSTITUTO PROVINCIAL DE EDUCACIÓN TÉCNICA Y AGROTÉCNICA (I.P.E.T.Y A.)",
                       "INSTITUTO PROVINCIAL DE EDUCACIÓN MEDIA Y TÉCNICA (I.P.E.M.Y T.)",
                       "INSTITUTO PROVINCIAL DE EDUCACIÓN MEDIA Y AGROTÉCNICA (I.P.E.M.Y A.)",
                       "CENTRO EDUCATIVO DE JÓVENES Y ADULTOS (C.E.J.A.)",
                       "CENTRO EDUCATIVO DE NIVEL MEDIO ADULTOS (C.E.N.M.A.)",
