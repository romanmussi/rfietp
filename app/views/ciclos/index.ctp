...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action'=>'view', $ciclo['Ciclo']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action'=>'edit', $ciclo['Ciclo']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action'=>'delete', $ciclo['Ciclo']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $ciclo['Ciclo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
