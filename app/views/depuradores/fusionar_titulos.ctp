...
<h1><?php __('Fusionar de Títulos de Referencia');?></h1>
Este depurador permite realizar búsquedas específicas de títulos y tomar dos o más de ellos para poder fusionarlos bajo un Título de Referencia.
...
?>
<?php 
        echo $form->create('Depurador', array(
            'action' => 'titulos_ajax_index_search',
        ...
        echo $form->button('Limpiar búsqueda', array(
                ...
                'onclick' => 'location.href="'.$html->url("fusionar_titulos").'/limpiar:1"',
         ));
